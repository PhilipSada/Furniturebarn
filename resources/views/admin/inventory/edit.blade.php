                                     ...
                                     <div class="card-body admin-form">
                                        <form method="POST" action="/admin/inventory/{{$product->id}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputImageOne">Image</label>
                                                        <input id="inputImageOne" type="text" class="form-control form-control-lg @error('image_url_1') is-invalid @enderror" name="image_url" value="{{ old('image_url', $product->image_url) }}" 
